-- Fix course reports to include session_title and all instructors including those with 0 responses
...
BEGIN
  ...
  -- Get all instructors who taught in this year (regardless of responses)
  all_instructors AS (
    SELECT DISTINCT
      instructor_id,
      instructor_name
  ...
  -- Use LEFT JOIN with all_instructors to include instructors with 0 responses
  instructor_pre AS (
    SELECT
      ai.instructor_id,
      ai.instructor_name,
