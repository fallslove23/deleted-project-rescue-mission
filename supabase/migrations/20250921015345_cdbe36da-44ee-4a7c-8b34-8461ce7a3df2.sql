-- Simply create the view without RLS policies for now
-- The view will use the underlying table's RLS policies through joins

-- Create survey_cumulative_stats view with simplified approach
