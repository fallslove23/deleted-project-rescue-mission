-- Create or replace the instructor_survey_stats view and grant select to client roles
...
-- Grant select to client roles
GRANT USAGE ON SCHEMA public TO authenticated;
GRANT SELECT ON public.instructor_survey_stats TO authenticated;
