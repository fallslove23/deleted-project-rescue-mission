-- Enhanced function to create missing course statistics and update existing ones
...
AS $$
BEGIN
  -- Insert new records for courses that don't exist in course_statistics
  ...
  SELECT DISTINCT
    ...
    s.education_round,
    s.course_name,
    COALESCE(s.expected_participants, 0) as course_days, -- Using expected_participants as placeholder
    ...
    0 as cumulative_count, -- Will be updated later
    96 as education_hours, -- Default value
    12 as education_days, -- Default value
    AVG(CASE 
