-- Fix nested aggregate usage in get_course_reports_working by computing aggregates in subqueries first
...
-- Ensure execute permission for anon and authenticated roles
GRANT EXECUTE ON FUNCTION public.get_course_reports_working(integer, text, integer, uuid, boolean) TO anon, authenticated;
