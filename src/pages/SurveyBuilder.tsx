  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <Button variant="ghost" onClick={() => navigate(-1)}><ArrowLeft className="w-4 h-4 mr-2" />뒤로</Button>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-end">
            <Button onClick={saveBasic} disabled={saving}><Save className="w-4 h-4 mr-2" />기본 정보 저장</Button>
          </div>
        </CardContent>
      </Card>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" onClick={() => { setSectionForm({name:"", description:""}); setEditingSection(null); setSectionDialogOpen(true); }}>
                <Plus className="w-4 h-4 mr-2" />섹션 추가
              </Button>
              <Button onClick={() => { setEditingQuestion(null); setQuestionDialogOpen(true); }}>
